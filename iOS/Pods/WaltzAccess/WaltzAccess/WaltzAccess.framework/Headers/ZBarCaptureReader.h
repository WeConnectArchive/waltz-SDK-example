...
- (void) didFinishCapturingFrames:(NSMutableArray *)capturedFrames;
...
// search the QR code in the image
- (CGRect) preLocalizeCode;

//Used to clear the array that holds the frames;
- (void) initSavedImagesContainer;
