...
#import <WaltzAccess/WaltzAccess.h>
...
@property (nonatomic, copy) NSDate * _Nullable displayStartDate;
...
- (nonnull instancetype)initWithFirstName:(NSString * _Nonnull)firstName lastName:(NSString * _Nonnull)lastName email:(NSString * _Nullable)email phone:(NSString * _Nullable)phone avatarPath:(NSString * _Nullable)avatarPath OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11WaltzAccess8WaltzLog")
@interface WaltzLog : NSObject
